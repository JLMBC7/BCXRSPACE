...
AFRAME.registerComponent('info-message', {
  ...
  addStyles: function () {
    var css =
      ...
      'height: 370px; background-color: white; border: 3px solid rgba(0,0,0,.75);' +
      ...
      '.a-info-message-button {background-size: 90% 90%; border: 0; bottom: 0; cursor: pointer; min-width: 82px; min-height: 34px; padding-right: 0; padding-top: 0; position: absolute; right: -24px; transition: background-color .05s ease; -webkit-transition: background-color .05s ease; z-index: 9999; border-radius: 8px; touch-action: manipulation;}' +
